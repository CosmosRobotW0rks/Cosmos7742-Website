  ...
  <div class="project-detail">
    <div class="container">
      ...
      <div class="detail-content">
        <h1 class="detail-title">{{ t.work.projects.icc2024.title }}</h1>
        <div class="detail-image" v-if="image">
          <img :src="image" alt="ICC 2024" />
        </div>
        <div class="detail-text">
          <p>
            {{ t.work.projects.icc2024.detail }}
          </p>
        </div>
      </div>
    </div>
...
import iccImage from '@/assets/images/AAA/ICC-Istanbul-toplu-2.jpg'

const { t } = useI18n()
const router = useRouter()
const image = iccImage
